...
namespace Inventario.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908000528_Conteos")]
    partial class Conteos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventario.Domain.Conteos.Conteo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("ConciliadoEn")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<Guid?>("MovimientoAjusteId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SucursalId", "Estado");

                    b.ToTable("Conteos", (string)null);
                });

            modelBuilder.Entity("Inventario.Domain.Conteos.ConteoDetalle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ConteoId", "ArticuloId")
                        .IsUnique();

                    b.ToTable("ConteoDetalles", (string)null);
                });
            ...
            modelBuilder.Entity("Inventario.Domain.Conteos.ConteoDetalle", b =>
                {
                    ...
                    b.HasOne("Inventario.Domain.Conteos.Conteo", "Conteo")
                        .WithMany("Detalles")
